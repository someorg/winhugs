...
{-# LINE 113 "System\Win32\Time.hsc" #-}
        sdat <- ((\hsc_ptr -> peekByteOff hsc_ptr 68)) buf
{-# LINE 114 "System\Win32\Time.hsc" #-}
...
{-# LINE 117 "System\Win32\Time.hsc" #-}
        snam <- peekCWString (plusPtr buf ((4)))
{-# LINE 118 "System\Win32\Time.hsc" #-}
        dnam <- peekCWString (plusPtr buf ((88)))
{-# LINE 119 "System\Win32\Time.hsc" #-}
...
{-# LINE 186 "System\Win32\Time.hsc" #-}
        c_GetTimeZoneInformation tzi
    tzi <- peek tzi
    return . flip (,) tzi $ case tz of
        (0)   -> TzIdUnknown
{-# LINE 190 "System\Win32\Time.hsc" #-}
        (1)  -> TzIdStandard
{-# LINE 191 "System\Win32\Time.hsc" #-}
        (2)  -> TzIdDaylight
{-# LINE 192 "System\Win32\Time.hsc" #-}
...
{-# LINE 294 "System\Win32\Time.hsc" #-}
