...
static void hugsprim_v7629_20(HugsStackPtr);
static void hugsprim_v7629_20(HugsStackPtr hugs_root)
{
    void (*v7629)(HsWord32 arg1);
    HsWord32 arg1;
    v7629 = (void (*)(HsWord32))hugs->getFunPtr();
    arg1 = hugs->getWord32();
    v7629(arg1);
...
static void hugsprim_v7630_10(HugsStackPtr);
static void hugsprim_v7630_10(HugsStackPtr hugs_root)
{
    void (*v7630)(HsPtr arg1);
    HsPtr arg1;
    v7630 = (void (*)(HsPtr))hugs->getFunPtr();
    arg1 = hugs->getPtr();
    v7630(arg1);
...
static void hugsprim_v7631_9(HugsStackPtr);
static void hugsprim_v7631_9(HugsStackPtr hugs_root)
{
    void (*v7631)(HsPtr arg1);
    HsPtr arg1;
    v7631 = (void (*)(HsPtr))hugs->getFunPtr();
    arg1 = hugs->getPtr();
    v7631(arg1);
...
static void hugsprim_v7632_6(HugsStackPtr);
static void hugsprim_v7632_6(HugsStackPtr hugs_root)
{
    void (*v7632)(HsPtr arg1);
    HsPtr arg1;
    v7632 = (void (*)(HsPtr))hugs->getFunPtr();
    arg1 = hugs->getPtr();
    v7632(arg1);
...
static void hugsprim_v7633_5(HugsStackPtr);
static void hugsprim_v7633_5(HugsStackPtr hugs_root)
{
    void (*v7633)(HsPtr arg1);
    HsPtr arg1;
    v7633 = (void (*)(HsPtr))hugs->getFunPtr();
    arg1 = hugs->getPtr();
    v7633(arg1);
...
static struct hugs_primitive hugs_primTable[] = {
    ...
    {"dyn_glActiveTextureARB", 3, hugsprim_v7629_20},
    ...
    {"dyn_glMultTransposeMatrixdARB", 3, hugsprim_v7630_10},
    {"dyn_glMultTransposeMatrixfARB", 3, hugsprim_v7631_9},
    {"glMultMatrixd", 2, hugsprim_glMultMatrixd_8},
    {"glMultMatrixf", 2, hugsprim_glMultMatrixf_7},
    {"dyn_glLoadTransposeMatrixdARB", 3, hugsprim_v7632_6},
    {"dyn_glLoadTransposeMatrixfARB", 3, hugsprim_v7633_5},
