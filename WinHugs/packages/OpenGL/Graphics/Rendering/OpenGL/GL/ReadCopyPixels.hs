...
foreign import stdcall unsafe "glReadPixels" glReadPixels ::
...
foreign import stdcall unsafe "glReadBuffer" glReadBuffer :: GLenum -> IO ()
...
foreign import stdcall unsafe "glCopyPixels" glCopyPixels ::
