...
foreign import stdcall unsafe "glBegin" glBegin :: GLenum -> IO ()

foreign import stdcall unsafe "glEnd" glEnd :: IO ()
...
foreign import stdcall unsafe "glEdgeFlag" glEdgeFlag :: GLboolean -> IO ()
