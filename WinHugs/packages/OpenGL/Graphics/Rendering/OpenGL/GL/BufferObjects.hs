...
foreign import stdcall unsafe "dynamic" dyn_glBindBufferARB :: Graphics.Rendering.OpenGL.GL.Extensions.Invoker (GLenum -> GLuint -> IO ()) ; glBindBufferARB :: (GLenum -> GLuint -> IO ()) ; glBindBufferARB = dyn_glBindBufferARB ptr_glBindBufferARB ; ptr_glBindBufferARB :: FunPtr a ; ptr_glBindBufferARB = unsafePerformIO (Graphics.Rendering.OpenGL.GL.Extensions.getProcAddress ("GL_ARB_vertex_buffer_object or OpenGL 1.5") ("glBindBufferARB")) ; {-# NOINLINE ptr_glBindBufferARB #-}
...
foreign import stdcall unsafe "dynamic" dyn_glBufferSubDataARB :: Graphics.Rendering.OpenGL.GL.Extensions.Invoker (GLenum -> GLintptr -> GLsizeiptr -> Ptr a -> IO ()) ; glBufferSubDataARB :: (GLenum -> GLintptr -> GLsizeiptr -> Ptr a -> IO ()) ; glBufferSubDataARB = dyn_glBufferSubDataARB ptr_glBufferSubDataARB ; ptr_glBufferSubDataARB :: FunPtr a ; ptr_glBufferSubDataARB = unsafePerformIO (Graphics.Rendering.OpenGL.GL.Extensions.getProcAddress ("GL_ARB_vertex_buffer_object or OpenGL 1.5") ("glBufferSubDataARB")) ; {-# NOINLINE ptr_glBufferSubDataARB #-}

foreign import stdcall unsafe "dynamic" dyn_glGetBufferSubDataARB :: Graphics.Rendering.OpenGL.GL.Extensions.Invoker (GLenum -> GLintptr -> GLsizeiptr -> Ptr a -> IO ()) ; glGetBufferSubDataARB :: (GLenum -> GLintptr -> GLsizeiptr -> Ptr a -> IO ()) ; glGetBufferSubDataARB = dyn_glGetBufferSubDataARB ptr_glGetBufferSubDataARB ; ptr_glGetBufferSubDataARB :: FunPtr a ; ptr_glGetBufferSubDataARB = unsafePerformIO (Graphics.Rendering.OpenGL.GL.Extensions.getProcAddress ("GL_ARB_vertex_buffer_object or OpenGL 1.5") ("glGetBufferSubDataARB")) ; {-# NOINLINE ptr_glGetBufferSubDataARB #-}
