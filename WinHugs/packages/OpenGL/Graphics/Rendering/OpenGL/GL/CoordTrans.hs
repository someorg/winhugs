...
foreign import stdcall unsafe "glDepthRange" glDepthRange ::
...
foreign import stdcall unsafe "glViewport" glViewport ::
...
foreign import stdcall unsafe "glMatrixMode" glMatrixMode :: GLenum -> IO ()
...
instance MatrixComponent Float where
   getMatrix = getFloatv
...
instance MatrixComponent Double where
...
foreign import stdcall unsafe "glLoadMatrixf" glLoadMatrixf :: Ptr GLfloat -> IO ()
foreign import stdcall unsafe "glLoadMatrixd" glLoadMatrixd :: Ptr GLdouble -> IO ()

foreign import stdcall unsafe "dynamic" dyn_glLoadTransposeMatrixfARB :: Graphics.Rendering.OpenGL.GL.Extensions.Invoker (Ptr GLfloat -> IO ()) ; glLoadTransposeMatrixfARB :: (Ptr GLfloat -> IO ()) ; glLoadTransposeMatrixfARB = dyn_glLoadTransposeMatrixfARB ptr_glLoadTransposeMatrixfARB ; ptr_glLoadTransposeMatrixfARB :: FunPtr a ; ptr_glLoadTransposeMatrixfARB = unsafePerformIO (Graphics.Rendering.OpenGL.GL.Extensions.getProcAddress ("GL_ARB_transpose_matrix or OpenGL 1.3") ("glLoadTransposeMatrixfARB")) ; {-# NOINLINE ptr_glLoadTransposeMatrixfARB #-}
foreign import stdcall unsafe "dynamic" dyn_glLoadTransposeMatrixdARB :: Graphics.Rendering.OpenGL.GL.Extensions.Invoker (Ptr GLdouble -> IO ()) ; glLoadTransposeMatrixdARB :: (Ptr GLdouble -> IO ()) ; glLoadTransposeMatrixdARB = dyn_glLoadTransposeMatrixdARB ptr_glLoadTransposeMatrixdARB ; ptr_glLoadTransposeMatrixdARB :: FunPtr a ; ptr_glLoadTransposeMatrixdARB = unsafePerformIO (Graphics.Rendering.OpenGL.GL.Extensions.getProcAddress ("GL_ARB_transpose_matrix or OpenGL 1.3") ("glLoadTransposeMatrixdARB")) ; {-# NOINLINE ptr_glLoadTransposeMatrixdARB #-}

foreign import stdcall unsafe "glMultMatrixf" glMultMatrixf :: Ptr GLfloat -> IO ()
foreign import stdcall unsafe "glMultMatrixd" glMultMatrixd :: Ptr GLdouble -> IO ()

foreign import stdcall unsafe "dynamic" dyn_glMultTransposeMatrixfARB :: Graphics.Rendering.OpenGL.GL.Extensions.Invoker (Ptr GLfloat -> IO ()) ; glMultTransposeMatrixfARB :: (Ptr GLfloat -> IO ()) ; glMultTransposeMatrixfARB = dyn_glMultTransposeMatrixfARB ptr_glMultTransposeMatrixfARB ; ptr_glMultTransposeMatrixfARB :: FunPtr a ; ptr_glMultTransposeMatrixfARB = unsafePerformIO (Graphics.Rendering.OpenGL.GL.Extensions.getProcAddress ("GL_ARB_transpose_matrix or OpenGL 1.3") ("glMultTransposeMatrixfARB")) ; {-# NOINLINE ptr_glMultTransposeMatrixfARB #-}
foreign import stdcall unsafe "dynamic" dyn_glMultTransposeMatrixdARB :: Graphics.Rendering.OpenGL.GL.Extensions.Invoker (Ptr GLdouble -> IO ()) ; glMultTransposeMatrixdARB :: (Ptr GLdouble -> IO ()) ; glMultTransposeMatrixdARB = dyn_glMultTransposeMatrixdARB ptr_glMultTransposeMatrixdARB ; ptr_glMultTransposeMatrixdARB :: FunPtr a ; ptr_glMultTransposeMatrixdARB = unsafePerformIO (Graphics.Rendering.OpenGL.GL.Extensions.getProcAddress ("GL_ARB_transpose_matrix or OpenGL 1.3") ("glMultTransposeMatrixdARB")) ; {-# NOINLINE ptr_glMultTransposeMatrixdARB #-}

foreign import stdcall unsafe "glRotatef" glRotatef :: GLfloat -> GLfloat -> GLfloat -> GLfloat -> IO ()
foreign import stdcall unsafe "glRotated" glRotated :: GLdouble -> GLdouble -> GLdouble -> GLdouble -> IO ()

foreign import stdcall unsafe "glTranslatef" glTranslatef :: GLfloat -> GLfloat -> GLfloat -> IO ()
foreign import stdcall unsafe "glTranslated" glTranslated :: GLdouble -> GLdouble -> GLdouble -> IO ()

foreign import stdcall unsafe "glScalef" glScalef :: GLfloat -> GLfloat -> GLfloat -> IO ()
foreign import stdcall unsafe "glScaled" glScaled :: GLdouble -> GLdouble -> GLdouble -> IO ()
...
foreign import stdcall unsafe "glLoadIdentity" loadIdentity :: IO ()

--------------------------------------------------------------------------------

foreign import stdcall unsafe "glOrtho" ortho ::
   GLdouble -> GLdouble -> GLdouble -> GLdouble -> GLdouble -> GLdouble -> IO ()

foreign import stdcall unsafe "glFrustum" frustum ::
   GLdouble -> GLdouble -> GLdouble -> GLdouble -> GLdouble -> GLdouble -> IO ()
...
foreign import stdcall unsafe "dynamic" dyn_glActiveTextureARB :: Graphics.Rendering.OpenGL.GL.Extensions.Invoker (GLenum -> IO ()) ; glActiveTextureARB :: (GLenum -> IO ()) ; glActiveTextureARB = dyn_glActiveTextureARB ptr_glActiveTextureARB ; ptr_glActiveTextureARB :: FunPtr a ; ptr_glActiveTextureARB = unsafePerformIO (Graphics.Rendering.OpenGL.GL.Extensions.getProcAddress ("GL_ARB_multitexture or OpenGL 1.3") ("glActiveTextureARB")) ; {-# NOINLINE ptr_glActiveTextureARB #-}   
...
foreign import stdcall unsafe "glPushMatrix" glPushMatrix :: IO ()

foreign import stdcall unsafe "glPopMatrix" glPopMatrix :: IO ()
...
foreign import stdcall unsafe "glGetTexGeniv" glGetTexGeniv ::
...
foreign import stdcall unsafe "glTexGeni" glTexGeni ::
...
foreign import stdcall unsafe "glGetTexGendv" glGetTexGendv ::
...
foreign import stdcall unsafe "glTexGendv" glTexGendv ::
   GLenum -> GLenum -> Ptr (Plane GLdouble) -> IO ()
