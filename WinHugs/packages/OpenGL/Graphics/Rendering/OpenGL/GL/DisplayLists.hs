...
foreign import stdcall unsafe "glGenLists" glGenLists :: GLsizei -> IO GLuint
...
foreign import stdcall unsafe "glDeleteLists" glDeleteLists ::
...
foreign import stdcall unsafe "glIsList" glIsList ::
...
foreign import stdcall unsafe "glNewList" glNewList ::
   DisplayList -> GLenum -> IO ()

foreign import stdcall unsafe "glEndList" glEndList :: IO ()
...
foreign import stdcall unsafe "glCallList" callList :: DisplayList -> IO ()

callLists :: GLsizei -> DataType -> Ptr a -> IO ()
callLists n = glCallLists n . marshalDataType

foreign import stdcall unsafe "glCallLists" glCallLists ::
...
foreign import stdcall unsafe "glListBase" glListBase :: DisplayList -> IO ()
