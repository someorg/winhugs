...
foreign import stdcall unsafe "glInitNames" glInitNames :: IO ()

foreign import stdcall unsafe "glSelectBuffer" glSelectBuffer ::
...
foreign import stdcall unsafe "glPopName" glPopName :: IO ()

foreign import stdcall unsafe "glPushName" glPushName :: Name -> IO ()

foreign import stdcall unsafe "glLoadName" loadName :: Name -> IO ()
