...
foreign import stdcall unsafe "glGenTextures"
   glGenTextures :: GLsizei -> Ptr GLuint -> IO ()

foreign import stdcall unsafe "glDeleteTextures"
   glDeleteTextures :: GLsizei -> Ptr GLuint -> IO ()

foreign import stdcall unsafe "glIsTexture"
...
foreign import stdcall unsafe "glBindTexture"
...
foreign import stdcall unsafe "glAreTexturesResident"
...
foreign import stdcall unsafe "glPrioritizeTextures"
