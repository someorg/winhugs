...
foreign import stdcall unsafe "glGetBooleanv" glGetBooleanv ::
...
foreign import stdcall unsafe "glGetIntegerv" glGetIntegerv ::
   GLenum -> Ptr GLint -> IO ()
...
foreign import stdcall unsafe "glGetFloatv" glGetFloatv ::
...
foreign import stdcall unsafe "glGetDoublev" glGetDoublev ::
