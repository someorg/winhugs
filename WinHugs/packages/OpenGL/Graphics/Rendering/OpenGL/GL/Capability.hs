...
foreign import stdcall unsafe "glIsEnabled" glIsEnabled ::
   GLenum -> IO GLboolean
...
foreign import stdcall unsafe "glDisable" glDisable :: GLenum -> IO ()

foreign import stdcall unsafe "glEnable" glEnable :: GLenum -> IO ()
