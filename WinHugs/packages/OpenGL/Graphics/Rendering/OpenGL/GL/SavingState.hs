...
foreign import stdcall unsafe "glPushAttrib"
   glPushAttrib :: GLbitfield -> IO ()

foreign import stdcall unsafe "glPopAttrib"
   glPopAttrib :: IO ()
...
foreign import stdcall unsafe "glPushClientAttrib"
   glPushClientAttrib :: GLbitfield -> IO ()

foreign import stdcall unsafe "glPopClientAttrib"
