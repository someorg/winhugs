...
static void v7620(HugsStablePtr fun1, void* unusedArg, HsPtr arg1, HsPtr arg2, HsPtr arg3, HsPtr arg4);
static void v7620(HugsStablePtr fun1, void* unusedArg, HsPtr arg1, HsPtr arg2, HsPtr arg3, HsPtr arg4)
{
...
static void hugsprim_v7620_17(HugsStackPtr);
static void hugsprim_v7620_17(HugsStackPtr hugs_root)
{
    HugsStablePtr arg1 = hugs->makeStablePtr4();
    void* thunk = hugs->mkThunk((HsFunPtr)v7620,arg1);
    hugs->putAddr(thunk);
...
static void v7621(HugsStablePtr fun1, void* unusedArg, HsWord32 arg1);
static void v7621(HugsStablePtr fun1, void* unusedArg, HsWord32 arg1)
{
    hugs->derefStablePtr4(fun1);
    hugs->putWord32(arg1);
...
static void hugsprim_v7621_15(HugsStackPtr);
static void hugsprim_v7621_15(HugsStackPtr hugs_root)
{
    HugsStablePtr arg1 = hugs->makeStablePtr4();
    void* thunk = hugs->mkThunk((HsFunPtr)v7621,arg1);
    hugs->putAddr(thunk);
    hugs->returnIO(hugs_root,1);
}
...
static void v7622(HugsStablePtr fun1, void* unusedArg);
static void v7622(HugsStablePtr fun1, void* unusedArg)
{
    hugs->derefStablePtr4(fun1);
    if (hugs->runIO(0)) {
...
static void hugsprim_v7622_13(HugsStackPtr);
static void hugsprim_v7622_13(HugsStackPtr hugs_root)
{
    HugsStablePtr arg1 = hugs->makeStablePtr4();
    void* thunk = hugs->mkThunk((HsFunPtr)v7622,arg1);
    hugs->putAddr(thunk);
    hugs->returnIO(hugs_root,1);
}
...
static void v7623(HugsStablePtr fun1, void* unusedArg, HsPtr arg1);
static void v7623(HugsStablePtr fun1, void* unusedArg, HsPtr arg1)
{
    hugs->derefStablePtr4(fun1);
    hugs->putPtr(arg1);
...
static void hugsprim_v7623_11(HugsStackPtr);
static void hugsprim_v7623_11(HugsStackPtr hugs_root)
{
    HugsStablePtr arg1 = hugs->makeStablePtr4();
    void* thunk = hugs->mkThunk((HsFunPtr)v7623,arg1);
    hugs->putAddr(thunk);
    hugs->returnIO(hugs_root,1);
}
...
static void v7624(HugsStablePtr fun1, void* unusedArg, HsWord8 arg1);
static void v7624(HugsStablePtr fun1, void* unusedArg, HsWord8 arg1)
{
    hugs->derefStablePtr4(fun1);
    hugs->putWord8(arg1);
...
static void hugsprim_v7624_9(HugsStackPtr);
static void hugsprim_v7624_9(HugsStackPtr hugs_root)
{
    HugsStablePtr arg1 = hugs->makeStablePtr4();
    void* thunk = hugs->mkThunk((HsFunPtr)v7624,arg1);
    hugs->putAddr(thunk);
    hugs->returnIO(hugs_root,1);
}
...
static void v7625(HugsStablePtr fun1, void* unusedArg, HsWord32 arg1);
static void v7625(HugsStablePtr fun1, void* unusedArg, HsWord32 arg1)
{
    hugs->derefStablePtr4(fun1);
    hugs->putWord32(arg1);
...
static void hugsprim_v7625_7(HugsStackPtr);
static void hugsprim_v7625_7(HugsStackPtr hugs_root)
{
    HugsStablePtr arg1 = hugs->makeStablePtr4();
    void* thunk = hugs->mkThunk((HsFunPtr)v7625,arg1);
    hugs->putAddr(thunk);
    hugs->returnIO(hugs_root,1);
}
