...
static void v7870(HugsStablePtr fun1, void* unusedArg, HsWord32 arg1);
static void v7870(HugsStablePtr fun1, void* unusedArg, HsWord32 arg1)
{
...
static void hugsprim_v7870_12(HugsStackPtr);
static void hugsprim_v7870_12(HugsStackPtr hugs_root)
{
    HugsStablePtr arg1 = hugs->makeStablePtr4();
    void* thunk = hugs->mkThunk((HsFunPtr)v7870,arg1);
    hugs->putAddr(thunk);
...
static void v7871(HugsStablePtr fun1, void* unusedArg);
static void v7871(HugsStablePtr fun1, void* unusedArg)
{
    hugs->derefStablePtr4(fun1);
    if (hugs->runIO(0)) {
...
static void hugsprim_v7871_10(HugsStackPtr);
static void hugsprim_v7871_10(HugsStackPtr hugs_root)
{
    HugsStablePtr arg1 = hugs->makeStablePtr4();
    void* thunk = hugs->mkThunk((HsFunPtr)v7871,arg1);
    hugs->putAddr(thunk);
    hugs->returnIO(hugs_root,1);
}
...
static void v7872(HugsStablePtr fun1, void* unusedArg, HsPtr arg1);
static void v7872(HugsStablePtr fun1, void* unusedArg, HsPtr arg1)
{
    hugs->derefStablePtr4(fun1);
    hugs->putPtr(arg1);
...
static void hugsprim_v7872_8(HugsStackPtr);
static void hugsprim_v7872_8(HugsStackPtr hugs_root)
{
    HugsStablePtr arg1 = hugs->makeStablePtr4();
    void* thunk = hugs->mkThunk((HsFunPtr)v7872,arg1);
    hugs->putAddr(thunk);
    hugs->returnIO(hugs_root,1);
}
...
static void v7873(HugsStablePtr fun1, void* unusedArg, HsPtr arg1);
static void v7873(HugsStablePtr fun1, void* unusedArg, HsPtr arg1)
{
    hugs->derefStablePtr4(fun1);
    hugs->putPtr(arg1);
...
static void hugsprim_v7873_6(HugsStackPtr);
static void hugsprim_v7873_6(HugsStackPtr hugs_root)
{
    HugsStablePtr arg1 = hugs->makeStablePtr4();
    void* thunk = hugs->mkThunk((HsFunPtr)v7873,arg1);
    hugs->putAddr(thunk);
    hugs->returnIO(hugs_root,1);
}
...
static void v7874(HugsStablePtr fun1, void* unusedArg, HsPtr arg1);
static void v7874(HugsStablePtr fun1, void* unusedArg, HsPtr arg1)
{
    hugs->derefStablePtr4(fun1);
    hugs->putPtr(arg1);
...
static void hugsprim_v7874_4(HugsStackPtr);
static void hugsprim_v7874_4(HugsStackPtr hugs_root)
{
    HugsStablePtr arg1 = hugs->makeStablePtr4();
    void* thunk = hugs->mkThunk((HsFunPtr)v7874,arg1);
    hugs->putAddr(thunk);
    hugs->returnIO(hugs_root,1);
}
...
static void v7875(HugsStablePtr fun1, void* unusedArg, HsWord32 arg1);
static void v7875(HugsStablePtr fun1, void* unusedArg, HsWord32 arg1)
{
    hugs->derefStablePtr4(fun1);
    hugs->putWord32(arg1);
...
static void hugsprim_v7875_2(HugsStackPtr);
static void hugsprim_v7875_2(HugsStackPtr hugs_root)
{
    HugsStablePtr arg1 = hugs->makeStablePtr4();
    void* thunk = hugs->mkThunk((HsFunPtr)v7875,arg1);
    hugs->putAddr(thunk);
    hugs->returnIO(hugs_root,1);
}
