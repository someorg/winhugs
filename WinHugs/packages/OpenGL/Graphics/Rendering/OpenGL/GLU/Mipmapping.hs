...
foreign import stdcall unsafe "gluScaleImage" gluScaleImage ::
...
foreign import stdcall unsafe "gluBuild1DMipmaps" gluBuild1DMipmaps ::
...
foreign import stdcall unsafe "gluBuild2DMipmaps" gluBuild2DMipmaps ::
