...
foreign import stdcall unsafe "gluOrtho2D" ortho2D ::
   GLdouble -> GLdouble -> GLdouble -> GLdouble -> IO ()

foreign import stdcall unsafe "gluPerspective" perspective ::
   GLdouble -> GLdouble -> GLdouble -> GLdouble -> IO ()
...
foreign import stdcall unsafe "gluLookAt" gluLookAt ::
...
foreign import stdcall unsafe "gluPickMatrix" gluPickMatrix ::
...
foreign import stdcall unsafe "gluProject" gluProject ::
      GLdouble -> GLdouble -> GLdouble
...
foreign import stdcall unsafe "gluUnProject" gluUnProject ::
      GLdouble -> GLdouble -> GLdouble
   -> Ptr GLdouble -> Ptr GLdouble -> Ptr GLint
   -> Ptr GLdouble -> Ptr GLdouble -> Ptr GLdouble -> IO GLint
